...
<div id="new-giving" class="fixed inset-0 z-50 hidden overflow-y-auto bg-black/40">
    <div class="flex min-h-full items-center justify-center p-4">
        <div class="card w-full max-w-2xl p-4 sm:p-6">
            ...
            <form id="new-giving-form" method="POST" action="<?php echo e(route('givings.store')); ?>" class="mt-4 space-y-4">
                <?php echo csrf_field(); ?>
                <div>
                        ...
                        <div id="partner-panel" class="combobox-panel hidden">
                            ...
                            <ul id="partner-options" class="combobox-options" role="listbox">
                                <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li role="option" class="combobox-option" data-id="<?php echo e($p->id); ?>" data-name="<?php echo e($p->fullName()); ?>" data-spouse="<?php echo e($p->spouse_name); ?>">
