        ...
        <table class="header-table">
            <tr>
                ...
                <td style="width: 140px;">
                    ...
                    <div class="doc-date"><?php echo e($statement->created_at->format('M j, Y')); ?></div>
                </td>
            </tr>
        </table>
            ...
            <table class="recipient-table">
                <tr>
                    <td>
                        ...
                        <span class="recipient-value"><?php echo e($partnerName); ?></span>
                    </td>
                    <?php if($spouseName): ?>
                        <td>
                            <span class="recipient-label">Spouse</span>
                            <span class="recipient-value"><?php echo e($spouseName); ?></span>
                        </td>
                    <?php endif; ?>
                </tr>
            </table>
