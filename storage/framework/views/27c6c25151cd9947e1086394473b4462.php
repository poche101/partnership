                ...
                <table role="presentation" width="100%"
                                ...
                                <tr>
                                    <?php if($logoBase64): ?>
                                        <td width="48" style="vertical-align: middle; padding-right: 12px;">
                                            <img src="<?php echo e($logoBase64); ?>" alt="Zone 5 Logo" width="40"
                                                height="40"
                                    ...
                                    <td align="right" style="vertical-align: middle;">
                                        ...
                                        <p style="margin: 2px 0 0 0; font-size: 12px; color: #4A5D70;">
                                            <?php echo e($generatedAt ?? now()->format('M j, Y')); ?></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <?php if(!empty($partnerName) || !empty($name)): ?>
                                <table role="presentation" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td style="padding-right: 24px;">
                                            ...
                                            <span
                                                style="display: block; font-size: 14px; color: #16324F; margin-top: 2px;"><?php echo e($partnerName ?? $name); ?></span>
                                        </td>
                                        <?php if(!empty($spouseName)): ?>
                                            <td>
                                                ...
                                                <span
                                                    style="display: block; font-size: 14px; color: #16324F; margin-top: 2px;"><?php echo e($spouseName); ?></span>
                                            </td>
                                        <?php endif; ?>
                                    </tr>
                                </table>
                    ...
                    <tr>
                        <td>
                            <div
                                ...
                                <?php echo e($messageBody ?? ($statement->content ?? '')); ?></div>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle; padding-left: 12px;">
                                        <p style="margin: 0; font-size: 11px; color: #4A5D70; line-height: 1.4;">
                                            ...
                                            system as of <?php echo e($generatedAt ?? now()->format('M j, Y')); ?>.
                                        </p>
                                    </td>
                                </tr>
                            </table>
...
</html><?php /**PATH C:\Users\kings\partnership\partnership\resources\views/statements/mail.blade.php ENDPATH**/ ?>